...
BACKUP_CMD="mongodump --out /backup/$BACKUP_NAME --host $MONGODB_BACKUP_HOST --port $MONGODB_BACKUP_PORT --username $MONGODB_BACKUP_USER --password $MONGODB_BACKUP_PASS --db $MONGODB_BACKUP_DB"
echo $BACKUP_CMD
